...
class WeightConverter:
    def __init__(self, master):
        ...
        Button(width=11, height=4, text="Kgs.", relief="flat", bg="white", command=lambda:self.show("/2.205")).place(x=0, y=50)
        Button(width=11, height=4, text="Lbs.", relief="flat", bg="white", command=lambda:self.show("*2.205")).place(x=90, y=50)
        Button(width=11, height=4, text="=", relief="flat", bg="lightblue", command=self.solve).place(x=180, y=50)
...
root=Tk()
weight_converter=WeightConverter(root)
root.mainloop()
